...
class JekyllSchedExportTool:
    ...
    def generate_resources_json_file(self, sessions):
        ...
        print("Resources.json file written. Please upload to https://s3.amazonaws.com/connect.linaro.org/{0}/resources.json".format(self.connect_code))
    ...
    def crud_jekyll_posts(self, sessions_data, users_data):
        ...
        for session in sessions_data:
            ...
            if skipping == False:
                ...
                post_file_name = datetime.datetime.now().strftime("%Y-%m-%d") + "-" + session_id.lower() + ".md"
...
if __name__ == "__main__":
    ...
    cards = JekyllSchedExportTool("san19/", "https://linaroconnectsandiego.sched.com")
